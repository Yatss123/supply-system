...
<div class="min-h-screen bg-gray-50 py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-6 flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Missing Items</h1>
                <p class="text-gray-600">Total missing: <span class="font-semibold">{{ number_format($totalMissing) }}</span></p>
            </div>
        ...
        <div class="bg-white shadow-sm sm:rounded-lg">
            <div class="p-6">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Missing Count</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ (int)($item->missing_count ?? 0) }}</td>
                ...
                @else
                    <p class="text-gray-600">No verified returns with missing items found.</p>
                @endif
            </div>
        </div>
    </div>

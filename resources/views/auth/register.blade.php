...
<head>
    ...
    <title>Register - Supply Management System</title>
    ...
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <div class="text-sm text-blue-700">
                <p>New users will be assigned the "Regular User" role by default.</p>
                <p class="text-xs mt-1">Contact an administrator to change your role if needed.</p>
            </div>
        </div>
